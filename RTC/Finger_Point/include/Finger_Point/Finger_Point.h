...
#ifndef FINGER_POINT_H
#define FINGER_POINT_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  Finger_Point(RTC::Manager* manager);
 ...
 protected:
  ...
  /*!
   */
  InPort<RTC::TimedDouble> m_commandIn;
  ...
  RTC::TimedDouble m_direction;
  /*!
   */
  OutPort<RTC::TimedDouble> m_directionOut;
...
extern "C"
{
  DLL_EXPORT void Finger_PointInit(RTC::Manager* manager);
};

#endif // FINGER_POINT_H
